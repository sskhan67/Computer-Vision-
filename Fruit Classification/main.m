...
n = input(' Connected component using Flood-fill used to complete object classification and Union find just implemented to view purpose.\n 1. Connected component using Flood-fill \n 2. Connected component using Union find \n');
